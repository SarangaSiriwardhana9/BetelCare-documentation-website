          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-xl text-gray-600 max-w-3xl">
                Advanced machine learning ensemble using XGBoost, Random Forest, and Gradient Boosting to predict optimal harvest times and expected yields for three betel leaf types.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent">
                <p className="text-white text-sm md:text-base">
                  Ensemble approach with R² values exceeding 0.85 for all three betel leaf types: P-Type, KT-Type, and RKT-Type.
                </p>
              </div>
            </motion.div>
              ...
              >
                ...
                <div className="space-y-8 mb-10">
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-xl font-medium mb-2">Dual Area Calculation Methods</h3>
                      <p className="text-gray-600">
                        Map-based algorithm using Google Maps SDK for outlined field boundaries, and GPS-based algorithm with walk-around measurement for irregular plots. Both methods integrate seamlessly with Supabase storage.
                      </p>
                    </div>
                  </motion.div>
